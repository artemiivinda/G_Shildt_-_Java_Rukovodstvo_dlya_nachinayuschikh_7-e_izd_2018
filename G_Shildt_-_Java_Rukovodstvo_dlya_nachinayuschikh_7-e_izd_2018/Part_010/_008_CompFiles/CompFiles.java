 ...
 * 
 * При вызове этой программы следует указать имена сравниваемых файлов. Например,
 * чтобы сравнить файл FIRST.TXT с файлом SECOND.TXT, в командной строке нужно
...
class CompFiles {
	...
	public static void main(String[] args) {
		...
		// Прежде всего необходимо убедиться в том, что программе передаются
		// имена обоих файлов
		if (args.length != 2) {

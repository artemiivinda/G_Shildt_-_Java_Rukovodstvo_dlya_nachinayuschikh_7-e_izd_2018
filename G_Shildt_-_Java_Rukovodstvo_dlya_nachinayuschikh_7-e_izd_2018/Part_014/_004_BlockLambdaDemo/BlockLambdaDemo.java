package _004_BlockLambdaDemo;

// Блочное лямбда-выражение, предназначенное для нахождения наименьшего
// положительного делителя заданного целого числа.

class BlockLambdaDemo {

	public static void main(String[] args) {
		// Данное блочное лямбда-выражение возвращает наименьший положительный
		// делитель заданного целого числа
